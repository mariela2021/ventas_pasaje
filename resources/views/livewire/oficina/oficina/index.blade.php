    ...
    <div class="container-fluid">
        <div class="form-row">
            ...
            <div class="col text-right">
                <a href="{{route('oficina.create')}}" class="btn btn-outline-primary btn-white">
                    <b>Agregar Oficina</b> 
                </a>
            </div>
        </div>
                                ...
                                <tbody>
                                    @foreach ($oficinas as $item)
                                        <tr>
                                            ...
                                            <td>{{$item->horario}}</td>
                                            <td class="td-actions">
                                                <a href="{{route('oficina.edit',$item->id)}}" class="btn btn-primary">
                                                <span class="material-icons">edit</span>
                                                </a>
                                                {{--eliminar--}}
                                                <form action="{{route('oficina.delete',$item->id)}}" method="post"
