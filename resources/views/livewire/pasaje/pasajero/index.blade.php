    ...
    <div class="container-fluid">
        <div class="form-row">
            ...
            <div class="col text-right">
                <a href="{{route('pasajero.create')}}" class="btn btn-outline-primary btn-white">
                                ...
                                <tbody>
                                    @foreach ($pasajeros as $item)
                                        <tr>
                                            ...
                                            <td class="td-actions">
                                                <a href="{{route('pasajero.edit',$item->id)}}" class="btn btn-primary">
                                                <span class="material-icons">edit</span>
                                                </a>
                                                <form action="{{route('pasajero.delete',$item->id)}}" method="post"
