...
<div class="content">
    <div class="container-fluid">
        <div class="row" style="margin-left: 10%">
            <div class="col-md-11">
                <form action="{{route('tipo_bus.update',$bus->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                name="descripcion"
                                value="{{ old('descripcion',$bus->descripcion) }}" autofocus cols="60" rows="3" placeholder="Descripcion..."></textarea>                                
