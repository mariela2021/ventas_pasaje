@extends('layouts.app', ['activePage' => 'venta_pasaje', 'titlePage' => __('Crear Venta de Pasaje')])
...
<div class="content">
    <div class="container-fluid">
        <div class="row" style="margin-left: 10%">
            <div class="col-md-11">
                <form action="{{route('venta_pasaje.update',$venta_pasaje->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                name="fecha"
                                id="_fecha"
                                value="{{old('fecha',$venta_pasaje->fecha)}}"
                                autofocus>
                                @if ($errors->has('fecha'))
