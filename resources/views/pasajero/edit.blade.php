@extends('layouts.app', ['activePage' => 'pasajero', 'titlePage' => __('Editar Pasajero')])
...
<div class="content">
    <div class="container-fluid">
        <div class="row" style="margin-left: 10%">
            <div class="col-md-11">
                <form action="{{route('pasajero.update',$pasajero->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control"
                                name="genero"
                                value="{{old('genero',$pasajero->genero)}}"
                                autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control"
                                name="direccion"
                                value="{{old('direccion',$pasajero->direccion)}}"
                                autofocus>
