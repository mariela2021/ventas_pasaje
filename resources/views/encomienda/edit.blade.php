...
<div class="content">
    <div class="container-fluid">
        <div class="row" style="margin-left: 10%">
            <div class="col-md-11">
                <form action="{{route('encomienda.update',$encomienda->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                name="nombre"
                                value="{{old('nombre',$encomienda->nombre)}}"
                                autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control"
                                name="apellido"
                                value="{{old('apellido',$encomienda->apellido)}}"
                                autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                value="{{old('telefono_remitente',$encomienda->telefono_remitente)}}"
                                autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control"
                                name="destinatario"
                                value="{{old('destinatario',$encomienda->destinatario)}}"
                                autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                value="{{old('telefono_destinatario',$encomienda->telefono_destinatario)}}"
                                autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control"
                                name="contenido"
                                value="{{old('contenido',$encomienda->contenido)}}"
                                autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control"
                                name="valor"
                                value="{{old('valor',$encomienda->valor)}}"
                                autofocus>
                                @if ($errors->has('valor'))
                                    <span class="error text-danger" for="input-nombre">
                                        {{ $errors->first('valor') }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                value="{{old('fecha_recepcion',$encomienda->fecha_recepcion)}}"
                                autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control"
                                name="estado"
                                value="{{old('estado',$encomienda->estado)}}"
                                autofocus>
