...
<div class="content">
    <div class="container-fluid">
        <div class="row" style="margin-left: 10%">
            <div class="col-md-11">
                <form action="{{route('personal_oficina.update',$personal_oficina->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                name="nombre"
                                value="{{old('nombre',$personal_oficina->nombre)}}"
                                autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control"
                                name="apellido"
                                value="{{old('apellido',$personal_oficina->apellido)}}"
                                autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control"
                                name="telefono"
                                value="{{old('telefono',$personal_oficina->telefono)}}"
                                autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control"
                                name="direccion"
                                value="{{old('direccion',$personal_oficina->direccion)}}"
                                autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control"
                                name="estado"
                                value="{{old('estado',$personal_oficina->estado)}}"
                                autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control"
                                name="fecha_ingreso"
                                value="{{old('fecha_ingreso',$personal_oficina->fecha_ingreso)}}"
                                autofocus>
