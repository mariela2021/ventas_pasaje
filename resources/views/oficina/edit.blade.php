...
<div class="content">
    <div class="container-fluid">
        <div class="row" style="margin-left: 10%">
            <div class="col-md-11">
                <form action="{{route('oficina.update',$oficina->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                name="nombre"
                                value="{{old('nombre',$oficina->nombre)}}" autofocus
                                >
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control"
                                name="horario"
                                value="{{old('horario',$oficina->horario)}}"
                                autofocus>
